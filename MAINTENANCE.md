...
- **Code Rollback:** Every customer release is tracked in git tags (`v1.0.0`, `v1.0.1`). If an upstream library regression occurs, revert to the previous release tag in git.
